...
public class GraphImporter implements AutoCloseable {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    try {
      ...
      // OTHERWISE HAVE LEFT BEHIND. THE DATABASE DIRECTORY ITSELF IS ALREADY CREATED BY THEN - main() RECREATES IT
      // BEFORE ANY OF THIS RUNS - SO WHAT A REFUSAL LEAVES ON DISK IS AN EMPTY DATABASE, NOT A HALF-BUILT SCHEMA
