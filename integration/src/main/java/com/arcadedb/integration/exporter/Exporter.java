...
public class Exporter {
  ...
  protected AbstractExporterFormat createFormatImplementation() {
    ...
    case "graphml": {
      try {
        final Class<AbstractExporterFormat> clazz = (Class<AbstractExporterFormat>) Class.forName("com.arcadedb.integration.exporter.format.GraphMLExporterFormat");
    ...
    case "graphson": {
      try {
        final Class<AbstractExporterFormat> clazz = (Class<AbstractExporterFormat>) Class.forName("com.arcadedb.integration.exporter.format.GraphSONExporterFormat");
        return clazz.getConstructor( DatabaseInternal.class,  ExporterSettings.class, ExporterContext.class, ConsoleLogger.class)
                .newInstance(database, settings, context, logger);
      } catch (InstantiationException | IllegalAccessException | InvocationTargetException | NoSuchMethodException | ClassNotFoundException e) {
