...
public class GraphQLSchema {
  /**
   * Prefix of the SQL parameter names generated by {@link #buildWhereClause}. It is deliberately unlikely to collide
   * with a name written by hand inside the free-form {@code where} argument, which is still interpolated verbatim.
   */
