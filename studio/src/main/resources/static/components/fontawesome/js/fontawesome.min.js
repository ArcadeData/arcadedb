...
!(function () {
  ...
  var T = R(
    ...
    D = R(
      (s((f = {}), I, { solid: "fas", regular: "far", light: "fal", thin: "fat", duotone: "fad", brands: "fab", kit: "fak" }), s(f, L, { solid: "fass" }), f),
    ),
    F = R(
    ...
    X = R((s((c = {}), I, { 900: "fas", 400: "far", normal: "far", 300: "fal", 100: "fat" }), s(c, L, { 900: "fass" }), c)),
    ...
    return (
      ...
      s
        ? ((p = (v = t).prefix),
          ...
          [{ tag: "svg", attributes: { style: "display: none;" }, children: [{ tag: "symbol", attributes: k(k({}, y), {}, { id: v }), children: h }] }])
        : ((g = (p = t).children),
          (y = p.main),
          (v = p.mask),
          (h = p.attributes),
          ...
          ot((p = p.transform)) &&
            ...
            (y = 0.5),
            (h.style = rt(k(k({}, t), {}, { "transform-origin": "".concat(v + p.x / 16, "em ").concat(y + p.y / 16, "em") })))),
            ...
            : (b.setAttribute(p, i),
              ...
              na(u, n)
                .then(function (t) {
                  ...
                  "::before" === v ? b.insertBefore(t, b.firstChild) : b.appendChild(t), (t.outerHTML = a.map(vt).join("\n")), b.removeAttribute(p), e();
                })
                .catch(t)))
        : e();
    });
