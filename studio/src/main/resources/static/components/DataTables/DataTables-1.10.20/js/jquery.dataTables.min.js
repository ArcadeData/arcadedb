...
(function (f) {
  ...
  function Pa(a, b) {
    ...
    if (c) {
      ...
      d.DT_RowClass &&
        ((a = d.DT_RowClass.split(" ")), (b.__rowc = b.__rowc ? ta(b.__rowc.concat(a)) : a), f(c).removeClass(b.__rowc.join(" ")).addClass(d.DT_RowClass));
  ...
  function pb(a) {
    ...
    for (b = k.length; l < b; l++) {
      ...
      h && m.appendTo(c);
      a.oFeatures.bSort &&
        (m.addClass(n.sSortingClass), !1 !== n.bSortable && (m.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Qa(a, n.nTh, l)));
  ...
  function Ja(a) {
    ...
    if (d || (!u && !h && !e && k == W(a) && k == n.length)) for (q = 0; q < k; q++) (l = ba(a, q)), null !== l && (c[l].sWidth = B(n.eq(q).width()));
      ...
      h && g
        ? k.width(g)
        : h
          ? (k.css("width", "auto"), k.removeAttr("width"), k.width() < p.clientWidth && m && k.width(p.clientWidth))
          : e
        ...
        if (-1 === f.inArray(!1, g) && ((g = a.iStateDuration), !((0 < g && b.time < +new Date() - 1e3 * g) || (b.columns && h.length !== b.columns.length)))) {
          ...
          if (b.columns)
            for (d = 0, e = b.columns.length; d < e; d++)
              (g = b.columns[d]), g.visible !== p && (h[d].bVisible = g.visible), g.search !== p && f.extend(a.aoPreSearchCols[d], Gb(g.search));
  ...
  function ka(a, b) {
    ...
    b <= c
      ...
      : a <= d
        ...
        : (a >= b - 1 - d ? (a = Z(b - (c - 2), b)) : ((a = Z(a - d + 2, a + d - 1)), a.push("ellipsis"), a.push(b - 1)),
  ...
  f.extend(v.prototype, {
    ...
    iterator: function (a, b, c, d) {
      ...
      return e.length || d
        ? ((a = new v(f, a ? e.concat.apply([], e) : e)), (b = a.selector), (b.rows = n.rows), (b.cols = n.cols), (b.opts = n.opts), a)
        : this;
    },
    lastIndexOf:
      G.lastIndexOf ||
        ...
        h = function (b, c) {
          if (f.isArray(b) || b instanceof f) for (var d = 0, g = b.length; d < g; d++) h(b[d], c);
            ...
            b.nodeName && "tr" === b.nodeName.toLowerCase()
              ? e.push(b)
              : ((d = f("<tr><td/></tr>").addClass(c)), (f("td", d).addClass(c).html(b)[0].colSpan = W(a)), e.push(d[0]));
        };
      h(c, d);
      ...
      function (b) {
        ...
        if (null === b || b === p || c) {
          ...
          for (q = e.length; m < q; m++)
            for (k = e[m], u = 0; u < l; u++)
              (t = { row: k, column: u }), c ? ((v = d[k]), b(t, I(a, k, u), v.anCells ? v.anCells[u] : null) && n.push(t)) : n.push(t);
          return n;
        }
