...
(function (a) {
  ...
  b.ext.renderer.header.jqueryui = function (b, c, d, f) {
    ...
    d.bSortable && (g || h) ? (g && !h ? (e = "css_right ui-icon ui-icon-caret-1-n") : !g && h && (e = "css_right ui-icon ui-icon-caret-1-s")) : (e = "");
    a("<div/>")
    ...
    a(b.nTable).on("order.dt", function (a, g, h, k) {
      b === g &&
        ((a = d.idx),
        c.removeClass(f.sSortAsc + " " + f.sSortDesc).addClass("asc" == k[a] ? f.sSortAsc : "desc" == k[a] ? f.sSortDesc : d.sSortingClass),
        c
          ...
          .addClass("asc" == k[a] ? "css_right ui-icon ui-icon-triangle-1-n" : "desc" == k[a] ? "css_right ui-icon ui-icon-triangle-1-s" : e));
    });
  };
  b.TableTools &&
