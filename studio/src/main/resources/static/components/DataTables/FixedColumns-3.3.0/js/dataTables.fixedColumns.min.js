  ...
  c.extend(p.prototype, {
    ...
    _fnConstruct: function (a) {
      ...
      if ("function" != typeof this.s.dt.oInstance.fnVersionCheck || !0 !== this.s.dt.oInstance.fnVersionCheck("1.8.0"))
        alert("FixedColumns " + p.VERSION + " required DataTables 1.8.0 or later. Please upgrade your DataTables installation");
        ...
        c(this.dom.scroller)
          ...
          .on("scroll.DTFC", function (a) {
            ...
            "main" === d &&
              ...
              0 < b.s.iRightColumns && (b.dom.grid.right.liner.scrollTop = b.dom.scroller.scrollTop));
          });
          ...
          c(b.dom.grid.left.liner)
            ...
            .on("scroll.DTFC", function (a) {
              ...
              "left" === d &&
                ...
                0 < b.s.iRightColumns && (b.dom.grid.right.liner.scrollTop = b.dom.grid.left.liner.scrollTop));
            })
            .on(f, function (a) {
          ...
          c(b.dom.grid.right.liner)
            ...
            .on("scroll.DTFC", function (a) {
              ...
              "right" === d &&
                ...
                0 < b.s.iLeftColumns && (b.dom.grid.left.liner.scrollTop = b.dom.grid.right.liner.scrollTop));
            })
            .on(f, function (a) {
              b.dom.scroller.scrollLeft -= "wheel" === a.type ? -a.originalEvent.deltaX : a.originalEvent.wheelDeltaX;
            });
      ...
      c.each(this.s.dt.aoColumns, function (h, f) {
        ...
        if (f.filter(":visible").length) {
          ...
          a.s.aiOuterWidths.length === a.s.dt.aoColumns.length - 1 &&
            ((k = c(a.s.dt.nTable).css("border-right-width")), (m += "string" === typeof k && -1 === k.indexOf("px") ? 1 : parseInt(k, 10)));
    ...
    _fnGridSetup: function () {
      ...
      this.s.dt.nTFoot &&
        ...
        0 < this.s.iRightColumns && (this.dom.grid.right.foot = h.childNodes[2]));
    ...
    _fnGridLayout: function () {
      ...
      var d = this.s.dt.nTable.parentNode.offsetHeight,
        ...
        w = function (b, d) {
          f.bar
            ...
            : ((b.style.width = d + 20 + "px"), (b.style.paddingRight = "20px"), (b.style.boxSizing = "border-box"));
        };
      f.x && (d -= f.bar);
      ...
      0 < this.s.iLeftColumns &&
        ...
        (h.style.width = m + "px"),
        (h.style.height = "1px"),
        x ? ((h.style.left = ""), (h.style.right = 0)) : ((h.style.left = 0), (h.style.right = "")),
      ...
      0 < this.s.iRightColumns &&
        ...
        (h.style.width = k + "px"),
        (h.style.height = "1px"),
        this.s.rtl ? ((h.style.left = f.y ? f.bar + "px" : 0), (h.style.right = "")) : ((h.style.left = ""), (h.style.right = f.y ? f.bar + "px" : 0)),
      ...
      for (var h = [], f = [], m = [], k = 0, x = a.length; k < x; k++) {
        ...
        for (var e = 0, n = this.s.iTableColumns; e < n; e++)
          if (-1 !== c.inArray(e, b)) {
            ...
            -1 === g
              ? ((g = c(a[k][e].cell).clone(d, !1)[0]), f.push(g), m.push(a[k][e].cell), w.push({ cell: g, unique: a[k][e].unique }))
    ...
    _fnClone: function (a, b, d, h) {
      ...
      e.oScroller !== q &&
        ((m = e.oScroller.dom.force), b.forcer ? (b.forcer.style.height = m.style.height) : ((b.forcer = m.cloneNode(!0)), b.liner.appendChild(b.forcer)));
      ...
      if (null !== e.nTFoot) {
        if (h) {
          ...
          for (g = this._fnCopyLayout(e.aoFooter, d, !1), b = [], e.oApi._fnDetectHeader(b, c(">tfoot", a.footer)[0]), n = 0, m = g.length; n < m; n++)
    ...
    _fnGetTrNodes: function (a) {
      for (var b = [], c = 0, e = a.childNodes.length; c < e; c++) "TR" == a.childNodes[c].nodeName.toUpperCase() && b.push(a.childNodes[c]);
      return b;
    },
    _fnEqualiseHeights: function (a, b, d) {
      if ("none" != this.s.sHeightMatch || "thead" === a || "tfoot" === a) {
        ...
        d = 0;
        for (a = b.length; d < a; d++) (b[d].style.height = f[d] + "px"), (e[d].style.height = f[d] + "px");
      }
    },
