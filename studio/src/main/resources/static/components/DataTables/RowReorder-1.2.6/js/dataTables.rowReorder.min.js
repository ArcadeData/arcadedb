...
(function (a) {
  ...
  a.extend(m.prototype, {
    ...
    _mouseMove: function (c) {
      this._clonePosition(c);
      for (
        var e = this._eventToPage(c, "Y") - this.s.bodyTop, b = this.s.middles, d = null, f = this.s.dt, g = f.table().body(), l = 0, h = b.length;
        l < h;
        l++
      )
        if (e < b[l]) {
    ...
    _shiftScroll: function (a) {
      ...
      h || l ? ((b.windowVert = h), (b.dtVert = l), (f = !0)) : this.s.scrollInterval && (clearInterval(this.s.scrollInterval), (this.s.scrollInterval = null));
