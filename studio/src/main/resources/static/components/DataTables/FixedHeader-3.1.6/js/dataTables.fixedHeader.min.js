  ...
  c.extend(m.prototype, {
    ...
    _clone: function (a, b) {
      ...
      !b && d.floating
        ...
        : (d.floating && (d.placeholder.remove(), this._unsize(a), d.floating.children().detach(), d.floating.remove()),
          (d.floating = c(e.table().node().cloneNode(!1)).css("table-layout", "fixed").attr("aria-hidden", "true").removeAttr("id").append(k).appendTo("body")),
    ...
    _positions: function () {
      ...
      k.length
        ? ((b.tfootTop = k.offset().top), (b.tfootBottom = b.tfootTop + k.outerHeight()), (b.tfootHeight = b.tfootBottom - b.tfootTop))
        : ((b.tfootTop = b.tbodyTop + e.outerHeight()), (b.tfootBottom = b.tfootTop), (b.tfootHeight = b.tfootTop));
    },
    _scroll: function (a) {
      var b = c(g).scrollTop(),
        e = c(g).scrollLeft(),
      ...
      this.c.footer &&
        ...
        (this.s.enable &&
          (k =
            !d.visible || b + d.windowHeight >= d.tfootBottom + this.c.footerOffset
              ? "in-place"
              : d.windowHeight + b > d.tbodyTop + d.tfootHeight + this.c.footerOffset
                ? "in"
                : "above"),
