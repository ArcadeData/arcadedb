      ...
      if (g.isPlainObject(c)) B(c);
        ...
        if (v) {
          ...
          for (h = e.length; f < h; f++)
            (k = c.createAttribute(e[f].name.replace(":", "_dt_b_namespace_token_"))), (k.value = e[f].value), d.setAttributeNode(k);
        }
          ...
          for (var b = 0, c = a.length; b < c; b++) {
            ...
            k ||
              ("number" === typeof a[b] || (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                ? (k = r(e, "c", { attr: { t: "n", r: l }, children: [r(e, "v", { text: a[b] })] }))
                : ((q = a[b].replace ? a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "") : a[b]),
                  (k = r(e, "c", { attr: { t: "inlineStr", r: l }, children: { row: r(e, "is", { children: { row: r(e, "t", { text: q }) } }) } }))));
            n.appendChild(k);
          }
          h.appendChild(n);
          f++;
