  ...
  })(
    {
            ...
            return (
              ...
              (a.prototype.computeDerivatives = function (a) {
                ...
                if (!(c < 1)) {
                  for (var d, e = new Array(this.k), f = new Array(this.k), g = new Array(this.k), h = 0, i = 0; i < c; ++i) {
                    ...
                    for (var j = 0; j < c; ++j)
                      if (i !== j) {
                        ...
                        if ((q > 1 && o > p) || !isFinite(p)) for (d = 0; d < this.k; ++d) this.H[d][i][j] = 0;
                        else {
                          q > 1 && (q = 1);
                          var r = p * p,
                            s = (2 * q * (o - p)) / (r * o),
                  ...
                  for (
                    var v = this.snapGridSize / 2, w = this.snapGridSize, x = this.snapStrength, y = x / (v * v), z = this.numGridSnapNodes, i = 0;
                    i < z;
                    ++i
                  )
                    for (d = 0; d < this.k; ++d) {
                      ...
                      -v < m &&
                        m <= v &&
                        (this.scaleSnapByMaxH ? ((this.g[d][i] += h * y * m), (this.H[d][i][i] += h * y)) : ((this.g[d][i] += y * m), (this.H[d][i][i] += y)));
                    }
                  this.locks.isEmpty() ||
              ...
              (a.prototype.computeStepSize = function (b) {
                for (var c = 0, d = 0, e = 0; e < this.k; ++e)
                  (c += a.dotProd(this.g[e], b[e])), a.rightMultiply(this.H[e], b[e], this.Hd[e]), (d += a.dotProd(b[e], this.Hd[e]));
      ...
      8: [
        function (a, b, c) {
          ...
          var F = (function () {
            function a(a, b) {
              if (((this.P = a), (this.V = []), (this.E = []), b)) (this.V = b.V.slice(0)), (this.E = b.E.slice(0));
              else {
              ...
              p.forEach(function (a) {
                ...
                p.forEach(function (a, b) {
                  ...
                  for (var f = 1; f < a.verts.length; f++) {
                    var g = a.verts[f - 1],
                      i = a.verts[f];
                    (g.node && g.node === i.node && g.node.leaf) || e.edges.push({ source: g.id, target: i.id, length: Math.abs(d(g, i)) });
                  }
                });
            }
            return (
              ...
              (a.getSegmentSets = function (a, b, c) {
                ...
                for (var j = [], k = null, l = 0; l < d.length; l++) {
                  var h = d[l];
                  (!k || Math.abs(h[0][b] - k.pos) > 0.1) && ((k = { pos: h[0][b], segments: [] }), j.push(k)), k.segments.push(h);
                }
                return j;
              }),
                    ...
                    for (var l = 0; l < h; l++)
                      if (k !== l) {
                        var m = d[k],
                          ...
                          r = -1;
                        "x" == a
                          ? f(o, p) && (m[0][b] < m[1][b] ? ((q = l), (r = k)) : ((q = k), (r = l)))
              ...
              (a.nudgeSegments = function (b, c, d, e, f) {
                for (var g = a.getSegmentSets(b, c, d), h = 0; h < g.length; h++) {
                  for (var i = g[h], j = [], k = 0; k < i.segments.length; k++) {
                    var l = i.segments[k];
                    j.push({ type: 0, s: l, pos: Math.min(l[0][d], l[1][d]) }), j.push({ type: 1, s: l, pos: Math.max(l[0][d], l[1][d]) });
                  }
                  j.sort(function (a, b) {
      ...
      10: [
        function (a, b, c) {
          ...
          function d(a, b, c, d, e) {
            ...
            0 != a.length &&
              ...
              (function (a, b) {
                ...
                for (
                  var e = (p = q), h = (r = i(a)), j = 0, k = Number.MAX_VALUE, l = Number.MAX_VALUE, m = -1, n = Number.MAX_VALUE, o = Number.MAX_VALUE;
                  ...
                  if (
                    ...
                    k < c && ((c = k), (d = p)),
                    l < c && ((c = l), (d = r)),
                    k > l ? ((e = p), (p = r), (k = l), (m = 1)) : ((h = r), (r = p), (l = k), (m = 0)),
                    j++ > 100)
                  )
                    break;
                }
              ...
              (function (a) {
                a.forEach(function (a) {
                  ...
                  var c = { x: b.x - a.width / 2, y: b.y - a.height / 2 },
                    d = { x: a.x - c.x + m / 2 - o / 2, y: a.y - c.y + n / 2 - p / 2 };
                  a.array.forEach(function (a) {
                    (a.x += d.x), (a.y += d.y);
                  });
                });
          ...
          Object.defineProperty(c, "__esModule", { value: !0 });
          var f = { PADDING: 10, GOLDEN_SECTION: (1 + Math.sqrt(5)) / 2, FLOAT_EPSILON: 1e-4, MAX_INERATIONS: 100 };
      ...
      11: [
            ...
            return (
              ...
              (a.prototype.tick = function () {
                if (this._alpha < this._threshold)
                  return (this._running = !1), this.trigger({ type: e.end, alpha: (this._alpha = 0), stress: this._lastStress }), !0;
                var a,
                  b,
              ...
              (a.prototype.alpha = function (a) {
                return arguments.length
                  ? ((a = +a),
                    this._alpha
                      ? (this._alpha = a > 0 ? a : 0)
                      : a > 0 && (this._running || ((this._running = !0), this.trigger({ type: e.start, alpha: (this._alpha = a) }), this.kick())),
                    this)
                  : this._alpha;
              }),
              ...
              (a.prototype.start = function (b, c, d, e, f) {
                ...
                this._nodes.forEach(function (a, b) {
                  (a.index = b), void 0 === a.x && ((a.x = o / 2), (a.y = p / 2)), (q[b] = a.x), (r[b] = a.y);
                }),
                  this._linkLengthCalculator && this._linkLengthCalculator();
                var u;
                this._distanceMatrix
                  ? (u = this._distanceMatrix)
                  : ((u = new j.Calculator(n, this._links, a.getSourceIndex, a.getTargetIndex, function (a) {
                    ...
                    this._links.forEach(function (a) {
                      "number" == typeof a.source && (a.source = k._nodes[a.source]), "number" == typeof a.target && (a.target = k._nodes[a.target]);
                    }),
                ...
                if (this._rootGroup && void 0 !== this._rootGroup.groups) {
                  ...
                  this._groups.forEach(function (a) {
                    w(l, l + 1, k._groupCompactness, 0.1), (q[l] = 0), (r[l++] = 0), (q[l] = 0), (r[l++] = 0);
                  });
              ...
              (a.prototype.routeEdge = function (a, b, c) {
                void 0 === b && (b = 5);
                var d = [],
                  e = new k.TangentVisibilityGraph(this._visibilityGraph.P, { V: this._visibilityGraph.V, E: this._visibilityGraph.E }),
        ...
        { "./descent": 7, "./geom": 8, "./handledisconnected": 10, "./linklengths": 13, "./powergraph": 14, "./rectangle": 17, "./shortestpaths": 18 },
      ],
      12: [
        function (a, b, c) {
          "use strict";
            ...
            a.forAll(function (a) {
              if (a.isLeaf()) b.leaves || (b.leaves = []), b.leaves.push(a.id);
                ...
                if (((a.gid = c.length), !a.isIsland() || a.isPredefined())) {
                  if (((e = { id: a.gid }), a.isPredefined())) for (var f in a.definition) e[f] = a.definition[f];
            ...
            h = (function (a) {
              ...
              return (
                    ...
                    for (i.right = this._root; ; ) {
                      if (
                        (null === k
                          ...
                          : b.is_red(k.left) && b.is_red(k.right) && ((k.red = !0), (k.left.red = !1), (k.right.red = !1)),
                ...
                (b.prototype.remove = function (a) {
                  ...
                  return (
                    null !== h && ((h.data = d.data), e.set_child(e.right === d, d.get_child(null === d.left)), this.size--),
                    (this._root = c.right),
        ...
        function (a, b, c) {
          ...
          function e(a, b, c) {
            var d = a.rayIntersection(b.cx(), b.cy()) || { x: a.cx(), y: a.cy() },
              ...
              h = Math.sqrt(f * f + g * g),
              i = h - c;
            return { sourceIntersection: d, targetIntersection: e, arrowStart: { x: d.x + (i * f) / h, y: d.y + (i * g) / h } };
          }
          function f(a, b, c) {
          ...
          function k(a, b) {
            var c = function (c, d) {
              for (var e, f = b.findIter(a); null !== (e = f[c]()); ) {
                ...
                if (((g <= 0 || g <= e.r.overlapY(a.r)) && (a[c].insert(e), e[d].insert(a)), g <= 0)) break;
              }
            };
