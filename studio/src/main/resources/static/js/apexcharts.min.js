          ...
          [
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  "#" +
                  (16777216 + 65536 * (Math.round((a - r) * s) + r) + 256 * (Math.round((a - o) * s) + o) + (Math.round((a - n) * s) + n)).toString(16).slice(1)
                );
              },
            },
            {
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              "vertical" === e.label.orientation &&
                ((n = e.label.style.padding.left), (l = e.label.style.padding.right), (r = e.label.style.padding.top), (o = e.label.style.padding.bottom));
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                i && n.globals.memory.methodsToExec.push({ context: o, id: g.id ? g.id : x.randomId(), method: r, label: "addAnnotation", params: e }),
                a
              );
            },
          },
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              e = (e = (e = (e = e.replace(/(^|[^\\])HH+/g, "$1" + l(g))).replace(/(^|[^\\])H/g, "$1" + g)).replace(/(^|[^\\])hh+/g, "$1" + l(p))).replace(
                /(^|[^\\])h/g,
                "$1" + p,
              );
          ...
          },
          {
            ...
            value: function (t) {
              ...
              Array.isArray(o.pattern.style)
                ? (i =
                    void 0 !== o.pattern.style[n.seriesNumber] ? l.drawPattern(o.pattern.style[n.seriesNumber], o.pattern.width, o.pattern.height, c, h, s) : r)
            ...
            value: function (t, e, i, a, s, r, o) {
              var n = this.w,
                ...
                p = g.getMarkerConfig({
                  ...
                  dataPointIndex: r,
                  finishRadius:
                    "bubble" === n.config.chart.type || (n.globals.comboCharts && n.config.series[s] && "bubble" === n.config.series[s].type) ? a : null,
                });
              a = p.pSize;
              var f,
                x = d.fillPath({
              ...
              for (
                ...
                if (
                  ...
                  this.isFormat2DArray() ? this.handleFormat2DArray(t, d) : this.isFormatXY() && this.handleFormatXY(t, d),
                    ("candlestick" !== s.chart.type && "candlestick" !== t[d].type && "boxPlot" !== s.chart.type && "boxPlot" !== t[d].type) ||
              ...
              var h = [],
                ...
                v = function (t) {
                  ...
                  if (l.globals.axisCharts) {
                    ...
                    "datetime" === l.config.xaxis.type &&
                      (l.config.xaxis.categories.length ? (i = l.config.xaxis.categories[t]) : l.config.labels.length && (i = l.config.labels[t]));
              ...
              if (s.length > 0) {
                ...
                for (var d = 0; d < r.length; d++)
                  e.placeTextWithEllipsis(
                    r[d],
                    r[d].textContent,
                    t.config.yaxis[0].labels.maxWidth - (t.config.yaxis[0].title.text ? 2 * parseFloat(t.config.yaxis[0].title.style.fontSize) : 0) - 15,
                  );
              }
            },
          },
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (t, e, i) {
              e <= 0 && (e = Math.max(t, i)), t <= 0 && (t = Math.min(e, i));
              for (
                var a = [], s = Math.log(e) / Math.log(i), r = Math.log(t) / Math.log(i), o = s - r, n = Math.round(o), l = o / n, h = 0, c = r;
                h < n;
                h++, c += l
              )
                a.push(Math.pow(i, c));
                    ...
                    (function (t) {
                      if (e.dCtx.timescaleLabels && e.dCtx.timescaleLabels.length) {
                        ...
                        l > a.svgWidth - a.translateX - c && (a.skipLastTimelinelabel = !0),
                          h <
                            -((t.show && !t.floating) ||
                            ("bar" !== s.chart.type && "candlestick" !== s.chart.type && "rangeBar" !== s.chart.type && "boxPlot" !== s.chart.type)
                              ? 10
          ...
          },
          {
            ...
            value: function () {
              ...
              var d = function () {
                (i.translateX = l),
                  (i.gridHeight =
                    i.svgHeight - t.lgRect.height - h - (t.isSparkline || "treemap" === e.config.chart.type ? 0 : e.globals.rotateXLabels ? 10 : 15)),
              ...
              var r = [],
                o = function (i, a, s) {
                  ...
                  t.t[o] &&
                    ...
                    r.push({ el: a, icon: "string" == typeof t.t[o] ? t.t[o] : s, title: t.localeValues[i], class: "apexcharts-".concat(o, "-icon") });
                };
              o(
                "zoomIn",
                this.elZoomIn,
                ...
                var v = function (t, o) {
                    ...
                    (x = a.getSeriesName({ fn: v.yLbTitleFormatter, index: s, seriesIndex: s, j: r })),
                      "treemap" === c.config.chart.type &&
                        (x = v.yLbTitleFormatter(String(c.config.series[s].data[r].x), { series: c.globals.series, seriesIndex: s, dataPointIndex: r, w: c }));
            ...
            value: function (t) {
              ...
              b && (b.innerHTML = void 0 !== c ? c : ""),
                f[0] &&
                  ...
                  (l.config.tooltip.marker.fillColors && Array.isArray(l.config.tooltip.marker.fillColors) && (n = l.config.tooltip.marker.fillColors[e]),
              ...
              if (
                ...
                (s
                  ...
                  : a
                    ...
                    : ("heatmap" !== e && "treemap" !== e) ||
                      (n = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-heatmap, .apexcharts-series .apexcharts-treemap")),
                n && n.length)
              )
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (this.barCtx.lastActiveBarSerieIndex === r && f.enabled) {
                ...
                S ? ((y = C - g + Math.round(L.width / 2) - x - f.offsetX - 15), (A = "end")) : (y = C - g - Math.round(L.width / 2) + x + f.offsetX + 15),
                  (w = k + f.offsetY);
              }
              return (
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (
                null != t &&
                  (i = e - t / this.barCtx.yRatio[this.barCtx.yaxisIndex] + 2 * (this.barCtx.isReversed ? t / this.barCtx.yRatio[this.barCtx.yaxisIndex] : 0)),
                i
              );
            },
          },
        ...
        r(s, [
            ...
            value: function (t) {
              ...
              if ((h && (v = h.indexOf(g.config.series[p].name)), v > 0)) {
                ...
                this.groupCtx.prevXVal[v - 1][f] < 0
                  ...
                  : this.groupCtx.prevXVal[v - 1][f] >= 0 &&
                    (m = this.series[p][f] >= 0 ? this.groupCtx.prevX[v - 1][f] : this.groupCtx.prevX[v - 1][f] - x + 2 * (this.isReversed ? x : 0)),
                  (e = m);
              } else e = r;
              o =
          ...
          },
          {
            ...
            value: function (t) {
              ...
              a = this.series[d][g]
                ? f - this.series[d][g] / this.yRatio[this.yaxisIndex] + 2 * (this.isReversed ? this.series[d][g] / this.yRatio[this.yaxisIndex] : 0)
                : f;
                  ...
                  for (var b = 0; b < c.linePathsTo.length; b++) {
                    ...
                    var y = s.fillPath({ seriesNumber: n }),
                      w = i.graphics.renderPaths(
                        e(e({}, d), {}, { pathFrom: null === f ? c.areaPathsFrom[b] : f, pathTo: c.areaPathsTo[b], strokeWidth: 0, fill: y, drawShadow: !1 }),
                      );
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var n = e.config.plotOptions.radialBar.hollow.background,
                l =
                  t.size - o * t.series.length - this.margin * t.series.length - (o * parseInt(e.config.plotOptions.radialBar.track.strokeWidth, 10)) / 100 / 2,
        ...
        r(s, [
                ...
                for (
                  ...
                  if (this.isHorizontal) {
                    ...
                    v = (I = this.drawRangeBarPaths(
                      e({ indexes: { i: n, j: A, realIndex: p }, barHeight: b, barYPosition: M, zeroW: d, yDivision: h, y1: L, y2: P }, X),
                    )).barWidth;
                  } else {
                    ...
                    b = (I = this.drawRangeColumnPaths(e({ indexes: { i: n, j: A, realIndex: p }, barWidth: v, barXPosition: T, zeroH: c, xDivision: l }, X)))
                      .barHeight;
                  }
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                n.globals.isXNumeric || (i += a),
                { pathTo: x.pathTo, pathFrom: x.pathFrom, barHeight: f, x: i, y: p, goalY: this.barHelpers.getGoalValues("y", null, o, l, h), barXPosition: r }
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                { pathTo: u.pathTo, pathFrom: u.pathFrom, barWidth: g, x: d, goalX: this.barHelpers.getGoalValues("x", l, null, e.realIndex, e.j), y: i }
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              if ("area" === i)
                for (var p = l.fillPath({ seriesNumber: a }), f = 0; f < r.areaPaths.length; f++) {
                  var x = n.renderPaths(
                    e(e({}, u), {}, { pathFrom: r.pathFromArea, pathTo: r.areaPaths[f], stroke: "none", strokeWidth: 0, strokeLineCap: null, fill: p }),
                  );
                  this.elSeries.add(x);
                }
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                (i = t[2] - t[0]), (a = t[3] - t[1]), (s = i * a), (r = Math.pow(s, 0.5)), Math.min(r / o, parseInt(e.config.dataLabels.style.fontSize, 10))
              );
            },
          },
          {
        ...
        r(t, [
          {
            ...
            value: function () {
              var t = this.w.globals,
                ...
                i = e.chart.type;
              (t.axisCharts =
                ["line", "area", "bar", "rangeBar", "rangeArea", "candlestick", "boxPlot", "scatter", "bubble", "radar", "heatmap", "treemap"].indexOf(i) > -1),
    ...
    (Et = function (t, e) {
      ...
      (a.PathArray = function (t, e) {
        ...
        a.extend(a.Element, {
          ...
          fire: function (e, i) {
            return (
              e instanceof t.Event ? this.node.dispatchEvent(e) : this.node.dispatchEvent((e = new a.CustomEvent(e, { detail: i, cancelable: !0 }))),
              (this._event = e),
              this
            );
          },
