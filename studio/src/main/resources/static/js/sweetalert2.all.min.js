!(function (t, e) {
  ...
  var dt,
    ...
    vt = function (t) {
      var e,
        ...
        g =
          !!(e = Y()) &&
          (e.parentNode.removeChild(e), ft([document.documentElement, document.body], [W["no-backdrop"], W["toast-shown"], W["has-column"]]), !0);
      ct()
  ...
  function kt(t, e) {
    ...
    l &&
      ...
      (i = l),
      (r = e.position) in W ? pt(i, W[r]) : (N('The "position" parameter is not valid, defaulting to "center"'), pt(i, W.center)),
      (a = l),
  ...
  (Tt.text =
      ...
      function (t, e) {
        return (
          "string" == typeof e.inputValue || "number" == typeof e.inputValue
            ...
            : v(e.inputValue) || N('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')),
          xt(t, e),
          (t.type = e.input),
          t
        );
    ...
    (Tt.select = function (t, e) {
      ...
      return (
        (t.textContent = ""),
        e.inputPlaceholder &&
          ((n = document.createElement("option")), V(n, e.inputPlaceholder), (n.value = ""), (n.disabled = !0), (n.selected = !0), t.appendChild(n)),
        t
      );
    }),
    (Tt.radio = function (t) {
  ...
  function Lt(t, e) {
    ...
    e.html ? (ut(e.html, c), et(c, "block")) : e.text ? ((c.textContent = e.text), et(c, "block")) : nt(c),
      (n = t),
      (o = e),
      (i = k()),
  ...
  function It(t, s) {
    ...
    l >= s.progressSteps.length &&
      N("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
        ...
        : (Rt(),
          o.icon &&
            (-1 !== Object.keys(K).indexOf(o.icon)
              ? ((i = y(".".concat(W.icon, ".").concat(K[o.icon]))), et(i), Dt(i, o), Ht(), H(i, o, "icon"), pt(i, o.showClass.icon))
              : U('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(o.icon, '"')))),
      (function (t) {
        var e = x();
  ...
  var Rt = function () {
    ...
    _t = function (t, e) {
      (t.className = "".concat(W.popup, " ").concat(ht(t) ? e.showClass.popup : "")),
        e.toast ? (pt([document.documentElement, document.body], W["toast-shown"]), pt(t, W.toast)) : pt(t, W.modal),
        H(t, e, "popup"),
  ...
  function Qt(t) {
    for (var e in t)
      Yt((i = e)) || N('Unknown parameter "'.concat(i, '"')),
        t.toast && ((o = e), -1 !== te.indexOf(o) && N('The parameter "'.concat(o, '" is incompatible with toasts'))),
        Zt((n = e)) && g(n, Zt(n));
    var n, o, i;
  }
  var $t = {},
        ...
        return (
          "object" !== r(o[0]) || b(o[0])
            ? ["title", "html", "icon"].forEach(function (t, e) {
                ...
                "string" == typeof n || b(n)
                  ? (i[t] = n)
                  : void 0 !== n && U("Unexpected type of ".concat(t, '! Expected "string" or "Element", got ').concat(r(n)));
              })
            : s(i, o[0]),
          i
        );
  ...
  function ne() {
    ...
    e &&
      ...
      e.showConfirmButton || (nt(t.confirmButton), e.showCancelButton || nt(t.actions)),
    ...
    n
      ...
      j() &&
        ...
        R(document.body, W.iosfix) &&
          ((i = parseInt(document.body.style.top, 10)), ft(document.body, W.iosfix), (document.body.style.top = ""), (document.body.scrollTop = -1 * i)),
  ...
  function ve(t) {
    ...
    (e = t).inputValidator ||
      ...
      ((n = t).target && ("string" != typeof n.target || document.querySelector(n.target)) && ("string" == typeof n.target || n.target.appendChild)) ||
        (N('Target parameter is not valid, defaulting to "body"'), (n.target = "body")),
  ...
  function we(t, e) {
    "select" === e.input || "radio" === e.input
      ? Ie(t, e)
      : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(e.input) && v(e.inputValue) && je(t, e);
  }
  function Ce(t, e) {
  ...
  var Se = function (t, e) {
    ...
    Ee = function (t, e) {
      ...
      ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) || ("MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints)) &&
        !R(document.body, W.iosfix) &&
        ((n = document.body.scrollTop), (document.body.style.top = "".concat(-1 * n, "px")), pt(document.body, W.iosfix), ae()),
        "undefined" != typeof window && ie() && (re(), window.addEventListener("resize", re)),
        h(document.body.children).forEach(function (t) {
          t === Y() ||
            (function (t, e) {
    ...
    Ie = function (e, n) {
      ...
      v(n.inputOptions)
        ...
        : "object" === r(n.inputOptions)
          ? o(n.inputOptions)
          : U("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(r(n.inputOptions)));
    },
    je = function (e, n) {
      var o = e.getInput();
      nt(o),
    ...
    nn = Object.freeze({
      ...
      _destroy: function () {
        var t = Pt.domCache.get(this),
          e = Pt.innerParams.get(this);
        e &&
          (t.popup && $t.swalCloseEventFinishedCallback && ($t.swalCloseEventFinishedCallback(), delete $t.swalCloseEventFinishedCallback),
