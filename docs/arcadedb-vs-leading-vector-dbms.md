...
| Float16 vectors                                     | ❌                                               | ❌                                           | ✅                                           |
| BFloat16 vectors                                    | ❌                                               | ❌                                           | ✅                                           |
| INT8 vector type (pre-quantized ingest)             | ✅ `withEncoding(INT8)`, BINARY column ([#4132](https://github.com/ArcadeData/arcadedb/issues/4132) shipped, internals still float pending [jvector#665](https://github.com/datastax/jvector/issues/665)) | ✅                                           | ✅                                           |
