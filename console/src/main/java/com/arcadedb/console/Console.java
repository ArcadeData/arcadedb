...
// Fix: If there is no real interactive system terminal (like in a JUnit runner),
// feed it a safe dummy input stream so it never traps System.in monitor locks.
        java.io.InputStream inputStream = systemTerminal ? System.in : new ByteArrayInputStream(new byte[0]);

        terminal = TerminalBuilder.builder()
                .system(systemTerminal)
                .streams(inputStream, System.out) // Use decoupled stream
                .jni(true)
                .build();
