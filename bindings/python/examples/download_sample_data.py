...
- large: ml-large (~265 MB, ~33M ratings) - Default, realistic performance testing
...
Usage:
    python download_sample_data.py                # Downloads large dataset
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python download_sample_data.py              # Downloads large dataset (~265 MB)
...
Dataset sizes:
  ...
  small - ml-small (~100K ratings, ~9K movies, ~1 MB)
    ...
    parser.add_argument(
        ...
        choices=["small", "large"],
        default="large",
        help="Dataset size to download (default: large)",
    )
