...
with arcadedb.create_database(db_path) as db:
    ...
    db.command("sql", "CREATE PROPERTY Task.tags LIST")  # Array of strings
    ...
    # IMPORTANT: All write operations should use transactions for ACID guarantees
    ...
    with db.transaction():
        ...
        db.command(
            ...
            INSERT INTO Task SET
                ...
                due_datetime = '2024-01-12T10:30:00',
                estimated_hours = 0.5,
                priority_score = 30,
                cost = 0.00,
                task_id = '{str(uuid.uuid4())}'
