...
public class ThreeInstancesScenarioIT extends ResilienceTestTemplate {
  ...
  void name() throws IOException, InterruptedException {
    ...
    GenericContainer<?> arcade1 = createArcadeContainer("arcade1", "proxy:8667,proxy:8668", "majority", network);
    GenericContainer<?> arcade2 = createArcadeContainer("arcade2", "proxy:8666,proxy:8668", "majority", network);
    GenericContainer<?> arcade3 = createArcadeContainer("arcade3", "proxy:8666,proxy:8667", "majority", network);
