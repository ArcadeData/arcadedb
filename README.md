...
- Embedded from any language on top of the Java Virtual Machine
  - Embedded from Python using the [Python bindings](bindings/python/) (maintained at [arcadedb-embedded-python](https://github.com/humemai/arcadedb-embedded-python) with [documentation](https://humemai.github.io/arcadedb-embedded-python/))
