...
public class GremlinValueComparatorTest {
    @Test
    public void testOrderabilityOffsetDateTimeAndString() {
    ...
    @Test
    public void testOrderabilityMixedDateTypes() {
