 ...
 */
package com.arcadedb.gremlin.process;
 ...
 */
public class DebugProcessSuite extends AbstractGremlinSuite {
     ...
     * {@code testsToEnforce}.
     */
    public DebugProcessSuite(final Class<?> klass, final RunnerBuilder builder) throws InitializationError {
     ...
     * {@code testsToEnforce}.
     */
    public DebugProcessSuite(final Class<?> klass, final RunnerBuilder builder, final Class<?>[] testsToExecute) throws InitializationError {
