...
class Issue5560DictionaryRolloverReplicationIT extends BaseRaftHATest {
  ...
  void aDictionaryThatRollsOverOnTheLeaderIsUsableOnEveryFollower() throws Exception {
    ...
    testEachServer(serverIndex -> {
      ...
      // BOTH DIRECTIONS, FOR NAMES ON PAGE 0 AND FOR NAMES PAST IT. RESOLVING THE ID IS WHAT A WRITE NEEDS AND RESOLVING THE
      // NAME IS WHAT EVERY READ OF THESE RECORDS NEEDS, AND ONLY THE SECOND FAILS WHEN A FOLLOWER STOPPED AT PAGE 0
