...
/**
 * Integration tests for {@link RaftHAServer#waitForAppliedIndex} and
 * {@link RaftHAServer#getLastAppliedIndex}.
 *
...
class WaitForApplyTest extends BaseRaftHATest {
  ...
  void getLastAppliedIndexIncrementsAfterWrite() {
    ...
    final RaftHAServer raft = getRaftPlugin(leaderIndex).getRaftServer();
