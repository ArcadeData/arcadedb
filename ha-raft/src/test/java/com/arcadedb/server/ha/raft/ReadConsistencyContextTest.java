...
/**
 * Tests for {@link ReadConsistencyContext} thread-local lifecycle.
 *
...
class ReadConsistencyContextTest {
  ...
  void setAndClearContext() {
    ReadConsistencyContext.set(Database.READ_CONSISTENCY.READ_YOUR_WRITES, 42);
    ...
    ReadConsistencyContext.clear();
    assertThat(ReadConsistencyContext.get()).isNull();
  }
