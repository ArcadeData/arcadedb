...
/**
 * Unit tests for {@link HALog} verbose logging utility.
 *
...
class HALogTest {
  ...
  @Test
  void allLevelsEnabledAtMaxVerbosity() {
  ...
  @Test
  void logWithExceptionDoesNotThrow() {
    GlobalConfiguration.HA_LOG_VERBOSE.setValue(3);
    HALog.refreshLevel();
    HALog.log(this, HALog.BASIC, "error message: %s", new RuntimeException("test"), "details");
  }
}
