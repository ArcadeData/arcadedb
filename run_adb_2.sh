...
-Darcadedb.server.httpIncomingPort=2482 \
-Darcadedb.ha.quorum=majority \
-Darcadedb.server.plugins=RaftHAPlugin \
-Darcadedb.server.name=node_1"  && \
../package/target/arcadedb-26.4.1-SNAPSHOT.dir/arcadedb-26.4.1-SNAPSHOT/bin/server.sh \
-Dcom.sun.management.jmxremote=false -Dcom.sun.management.jmxremote.port=9999 -Dcom.sun.management.jmxremote.rmi.port=9998
