...
/**
 * datetime.fromepoch() function - creates a CypherDateTime from epoch seconds and nanoseconds.
 */
public class DateTimeFromEpochFunction implements StatelessFunction {
  @Override
