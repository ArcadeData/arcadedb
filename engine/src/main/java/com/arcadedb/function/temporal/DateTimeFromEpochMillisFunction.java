...
/**
 * datetime.fromepochmillis() function - creates a CypherDateTime from epoch milliseconds.
 */
public class DateTimeFromEpochMillisFunction implements StatelessFunction {
  @Override
  public String getName() {
    return "datetime.fromepochmillis";
  }
