 ...
 * <p>
 * Delegates to {@link VectorUtils#l2Distance(float[], float[])} which uses
 * JVector's SIMD-optimized implementation when available, with a scalar fallback.
 *
...
public class SQLFunctionVectorL2Distance extends SQLFunctionVectorAbstract {
  ...
  public Object execute(final Object self, final Identifiable currentRecord, final Object currentResult, final Object[] params,
    ...
    return VectorUtils.l2Distance(v1, v2);
  }
