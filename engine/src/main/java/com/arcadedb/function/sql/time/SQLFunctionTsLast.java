 ...
 * Syntax: ts_last(value, timestamp)
 */
public class SQLFunctionTsLast extends SQLAggregatedFunction {
  public static final String NAME = "ts.last";

  private Object lastValue;
  private long   maxTimestamp = Long.MIN_VALUE;

  public SQLFunctionTsLast() {
    super(NAME);
  }
