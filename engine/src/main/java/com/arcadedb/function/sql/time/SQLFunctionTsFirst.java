 ...
 * Syntax: ts_first(value, timestamp)
 */
public class SQLFunctionTsFirst extends SQLAggregatedFunction {
  public static final String NAME = "ts.first";

  private Object firstValue;
  private long   minTimestamp = Long.MAX_VALUE;

  public SQLFunctionTsFirst() {
    super(NAME);
  }
