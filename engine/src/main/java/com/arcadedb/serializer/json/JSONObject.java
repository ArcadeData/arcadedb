...
public class JSONObject {
  ...
  public JSONObject put(final String name, final Object value) {
    if (value == null || value instanceof JsonNull)
      ...
      object.addProperty(name, boolean1);
      ...
      object.add(name, new JSONArray(strings).getInternal());
      ...
      object.addProperty(name, enum1.name());
      ...
      if (dateFormatAsString == null)
        ...
        // SAVE AS STRING
        object.addProperty(name, new SimpleDateFormat(dateFormatAsString).format(date));
      ...
      object.addProperty(name, class1.getName());
    } else
