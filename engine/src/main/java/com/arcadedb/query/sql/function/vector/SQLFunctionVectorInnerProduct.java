 ...
 * The inner product takes into account both magnitude and direction.
 ...
 */
public class SQLFunctionVectorInnerProduct extends SQLFunctionVectorAbstract {
  public static final String NAME = "vectorInnerProduct";

  public SQLFunctionVectorInnerProduct() {
    super(NAME);
  }
  ...
  public String getSyntax() {
    return "vectorInnerProduct(<vector1>, <vector2>)";
  }
}
