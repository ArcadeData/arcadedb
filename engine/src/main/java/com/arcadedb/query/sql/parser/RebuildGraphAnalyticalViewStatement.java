...
public class RebuildGraphAnalyticalViewStatement extends DDLStatement {
  ...
  public ResultSet executeDDL(final CommandContext context) {
    ...
    if (liveView == null)
      throw new CommandExecutionException("Graph Analytical View '" + viewName + "' does not exist or is not loaded");

    liveView.build();

    final InternalResultSet result = new InternalResultSet();
    final ResultInternal r = new ResultInternal();
    r.setProperty("operation", "rebuild graph analytical view");
