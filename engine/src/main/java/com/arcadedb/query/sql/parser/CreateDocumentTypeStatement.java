...
public class CreateDocumentTypeStatement extends ODDLStatement {
  /**
   * Class name
   */
  ...
  public ResultSet executeDDL(CommandContext ctx) {
    ...
    result.setProperty("operation", "create document type");
  ...
  public CreateDocumentTypeStatement copy() {
    CreateDocumentTypeStatement result = new CreateDocumentTypeStatement(-1);
  ...
  public boolean equals(Object o) {
    ...
    CreateDocumentTypeStatement that = (CreateDocumentTypeStatement) o;
