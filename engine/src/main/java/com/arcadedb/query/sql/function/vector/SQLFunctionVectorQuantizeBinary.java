 ...
 */
public class SQLFunctionVectorQuantizeBinary extends SQLFunctionAbstract {
  public static final String NAME = "VECTOR_QUANTIZE_BINARY";
  ...
  public String getSyntax() {
    return "VECTOR_QUANTIZE_BINARY(<vector>)";
  }
