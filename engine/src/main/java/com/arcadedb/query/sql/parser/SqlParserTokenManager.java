...
private int jjMoveStringLiteralDfa0_0(){
   switch(curChar)
   {
      ...
      case 64:
         return jjStartNfaWithStates_0(0, 178, 1032);
      case 91:
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1009:
                  ...
                  if (kind > 246)
                     kind = 246;
                  { jjCheckNAddTwoStates(1009, 1006); }
                  break;
               case 1010:
                  if ((0xff000000000000L & l) == 0L)
                     break;
                  if (kind > 246)
                     kind = 246;
                  { jjCheckNAddTwoStates(1010, 1006); }
                  break;
               case 1073:
                  if ((0x3fe000000000000L & l) == 0L)
                     break;
               ...
               case 1079:
                  if (curChar == 45)
                     { jjCheckNAddTwoStates(1080, 1083); }
                  break;
               case 1080:
                  if ((0x3fe000000000000L & l) == 0L)
                     break;
               ...
               case 1085:
                  ...
                  if (kind > 165)
                     kind = 165;
                  { jjCheckNAddTwoStates(1085, 1082); }
                  break;
               case 1086:
                  if ((0xff000000000000L & l) == 0L)
                     break;
               ...
               case 1155:
                  ...
                  if (kind > 154)
                     kind = 154;
                  { jjCheckNAddTwoStates(1155, 1075); }
                  break;
               case 1156:
                  if ((0xff000000000000L & l) == 0L)
                     break;
                  if (kind > 154)
                     kind = 154;
                  { jjCheckNAddTwoStates(1156, 1075); }
                  break;
               case 1158:
                  if ((0x3ff000000000000L & l) != 0L)
                     { jjAddStates(120, 121); }
...
static final int[] jjnextStates = {
   32, 34, 35, 1088, 1089, 1100, 1122, 1124, 1077, 1087, 1076, 1077, 1087, 1118, 1120, 1089,
   1100, 84, 85, 20, 88, 89, 92, 93, 1115, 1116, 1117, 1121, 1102, 1104, 1110, 1111,
   1113, 22, 23, 25, 1074, 1075, 1076, 1077, 1087, 1088, 1089, 1100, 1154, 1156, 1075, 1157,
   1164, 1122, 1124, 1077, 1087, 1118, 1120, 1089, 1100, 16, 17, 20, 38, 39, 42, 52,
   53, 56, 84, 85, 20, 94, 95, 20, 343, 324, 378, 359, 414, 395, 850, 851,
   916, 917, 1004, 1007, 1008, 1010, 1006, 1079, 1080, 1083, 1084, 1086, 1082, 1091, 1092, 1095,
   1096, 1098, 1094, 1110, 1111, 1113, 1119, 1089, 1100, 1120, 1089, 1100, 1123, 1077, 1087, 1124,
   1077, 1087, 1127, 1128, 1131, 1140, 1141, 1144, 1158, 1159, 1165, 1166, 1167, 1032, 1036, 1039,
   1043, 1048, 1055, 1060, 1063, 1065, 1068, 1071, 1012, 1016, 1018, 1021, 1028, 924, 925, 930,
   942, 947, 953, 975, 979, 985, 990, 998, 912, 919, 885, 888, 891, 894, 906, 909,
   845, 846, 853, 854, 859, 860, 862, 870, 877, 791, 796, 801, 806, 810, 821, 827,
   832, 835, 842, 748, 750, 756, 766, 773, 782, 728, 732, 736, 739, 742, 690, 693,
   696, 700, 705, 712, 715, 717, 723, 656, 661, 666, 671, 676, 604, 607, 611, 619,
   625, 630, 635, 641, 647, 650, 589, 594, 598, 519, 524, 531, 538, 543, 549, 552,
   562, 565, 572, 579, 416, 421, 426, 432, 436, 441, 448, 454, 458, 465, 475, 485,
   ...
   118, 126, 1138, 1152, 5, 6, 18, 19, 40, 41, 43, 54, 55, 57, 86, 87,
   90, 91, 96, 97, 1105, 1106, 1108, 1129, 1130, 1132, 1142, 1143, 1145, 1160, 1161, 1162,
   1163, 1168, 1169, 38, 39, 52, 53, 1127, 1128, 1140, 1141,
};
...
static final long[] jjtoMore = {
   0x4c0L, 0x0L, 0x0L, 0x0L,
    ...
    private final int[] jjrounds = new int[1170];
    private final int[] jjstateSet = new int[2 * 1170];
