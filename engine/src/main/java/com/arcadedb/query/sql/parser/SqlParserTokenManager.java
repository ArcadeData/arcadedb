...
private int jjMoveStringLiteralDfa0_0(){
   switch(curChar)
   {
      ...
      case '$':
         return jjStartNfaWithStates_0(0, 175, 30);
      case '%':
         jjmatchedKind = 202;
      ...
      case '@':
         return jjStartNfaWithStates_0(0, 174, 973);
      case '[':
      ...
      case '`':
         return jjStartNfaWithStates_0(0, 176, 36);
      case '{':
      ...
      if (curChar < 64)
      {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1020:
                  if (curChar == 45)
                     { jjCheckNAddTwoStates(1021, 1024); }
                  break;
               case 1021:
                  if ((0x3fe000000000000L & l) == 0x0L)
                     break;
               ...
               case 1032:
                  if (curChar == 45)
                     { jjCheckNAddTwoStates(1033, 1036); }
                  break;
               case 1033:
                  if ((0x3fe000000000000L & l) == 0x0L)
                     break;
               ...
               case 1038:
                  ...
                  if (kind > 162)
                     kind = 162;
                  { jjCheckNAddTwoStates(1038, 1035); }
                  break;
               case 1039:
                  if ((0xff000000000000L & l) == 0x0L)
                     break;
                  if (kind > 162)
                     kind = 162;
                  { jjCheckNAddTwoStates(1039, 1035); }
                  break;
               case 1040:
                  if (curChar == 46)
               ...
               case 1053:
                  if (curChar == 39)
                     { jjCheckNAddTwoStates(1054, 1052); }
                  break;
               case 1054:
                  if ((0xffffff7fffffffffL & l) != 0x0L)
                     { jjCheckNAddTwoStates(1054, 1052); }
               ...
               case 1096:
                  ...
                  if (kind > 150)
                     kind = 150;
                  { jjCheckNAddTwoStates(1096, 1016); }
                  break;
               case 1097:
                  if ((0xff000000000000L & l) == 0x0L)
                     break;
                  if (kind > 150)
                     kind = 150;
                  { jjCheckNAddTwoStates(1097, 1016); }
                  break;
               case 1099:
                  if ((0x3ff000000000000L & l) != 0x0L)
                     { jjAddStates(113, 114); }
...
static final int[] jjnextStates = {
   32, 34, 35, 1029, 1030, 1041, 1063, 1065, 1018, 1028, 1017, 1018, 1028, 1059, 1061, 1030, 
   1041, 84, 85, 22, 88, 89, 92, 93, 1056, 1057, 1058, 1062, 1043, 1045, 1051, 1052, 
   1015, 1016, 1017, 1018, 1028, 1029, 1030, 1041, 1095, 1097, 1016, 1098, 1105, 1063, 1065, 1018, 
   1028, 1059, 1061, 1030, 1041, 18, 19, 22, 38, 39, 42, 52, 53, 56, 84, 85, 
   22, 94, 95, 22, 354, 335, 389, 370, 425, 406, 821, 822, 886, 887, 952, 955, 
   956, 958, 954, 1020, 1021, 1024, 1025, 1027, 1023, 1032, 1033, 1036, 1037, 1039, 1035, 1060, 
   1030, 1041, 1061, 1030, 1041, 1064, 1018, 1028, 1065, 1018, 1028, 1068, 1069, 1072, 1081, 1082, 
   1085, 1099, 1100, 1106, 1107, 1108, 973, 977, 980, 984, 989, 996, 1001, 1004, 1006, 1009, 
   1012, 960, 964, 966, 969, 894, 895, 900, 912, 917, 923, 927, 933, 938, 946, 882, 
   889, 855, 858, 861, 864, 876, 879, 816, 817, 824, 829, 830, 832, 840, 847, 762, 
   767, 772, 777, 781, 792, 798, 803, 806, 813, 728, 730, 736, 746, 753, 708, 712, 
   716, 719, 722, 670, 673, 676, 680, 685, 692, 695, 697, 703, 649, 654, 659, 664, 
   597, 600, 604, 612, 618, 623, 628, 634, 640, 643, 582, 587, 591, 524, 529, 536, 
   542, 545, 555, 558, 565, 572, 427, 432, 437, 443, 447, 452, 459, 463, 470, 480, 
   490, 500, 512, 259, 264, 267, 275, 279, 284, 290, 291, 299, 308, 309, 318, 323, 
   355, 390, 227, 231, 235, 242, 249, 252, 195, 202, 203, 209, 212, 216, 223, 129, 
   134, 136, 139, 146, 154, 163, 168, 172, 176, 181, 186, 189, 99, 103, 105, 107, 
   109, 110, 114, 118, 126, 1079, 1093, 5, 6, 20, 21, 24, 25, 40, 41, 43, 
   54, 55, 57, 86, 87, 90, 91, 96, 97, 1046, 1047, 1049, 1070, 1071, 1073, 1083, 
   1084, 1086, 1101, 1102, 1103, 1104, 1109, 1110, 38, 39, 52, 53, 1068, 1069, 1081, 1082, 
};
