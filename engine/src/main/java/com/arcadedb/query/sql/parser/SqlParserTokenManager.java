...
private int jjMoveStringLiteralDfa0_0(){
   switch(curChar)
   {
      ...
      case '@':
         return jjStartNfaWithStates_0(0, 185, 1037);
      case '[':
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1006:
                  ...
                  if (kind > 251)
                     kind = 251;
                  { jjCheckNAddTwoStates(1006, 1003); }
                  break;
               case 1007:
                  if ((0xff000000000000L & l) == 0x0L)
                     break;
                  if (kind > 251)
                     kind = 251;
                  { jjCheckNAddTwoStates(1007, 1003); }
                  break;
               case 1084:
                  if ((0x3fe000000000000L & l) == 0x0L)
                     break;
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1062:
                  ...
                  break;
               case 1063:
                  if ((0x80000000800000L & l) != 0x0L && kind > 151)
                     kind = 151;
                  break;
               case 1064:
                  if ((0x4000000040000L & l) != 0x0L)
...
static final int[] jjnextStates = {
   1099, 1100, 1111, 1137, 1139, 1088, 1098, 1087, 1088, 1098, 1133, 1135, 1100, 1111, 85, 86,
   17, 89, 90, 93, 94, 1130, 1131, 1132, 1136, 1113, 1115, 1121, 1122, 1124, 19, 20,
   22, 1085, 1086, 1087, 1088, 1098, 1099, 1100, 1111, 1169, 1171, 1086, 1172, 1179, 1137, 1139,
   1088, 1098, 1133, 1135, 1100, 1111, 33, 35, 36, 13, 14, 17, 19, 20, 24, 22,
   39, 40, 43, 53, 54, 57, 85, 86, 17, 95, 96, 17, 346, 327, 381, 362,
   417, 398, 1001, 1004, 1005, 1007, 1003, 1090, 1091, 1094, 1095, 1097, 1093, 1102, 1103, 1106,
   ...
   1182, 1037, 1041, 1044, 1048, 1055, 1058, 1061, 1064, 1069, 1076, 1081, 1009, 1013, 1016, 1018,
   1023, 1026, 1033, 936, 937, 941, 946, 958, 963, 969, 973, 976, 982, 987, 995, 927,
   931, 888, 891, 897, 903, 906, 909, 921, 924, 860, 861, 865, 870, 871, 873, 880,
   797, 802, 807, 812, 816, 825, 836, 842, 847, 850, 857, 754, 756, 762, 772, 779,
   788, 721, 723, 725, 727, 728, 732, 739, 743, 751, 704, 708, 712, 715, 673, 676,
   679, 683, 690, 693, 699, 652, 657, 662, 667, 600, 603, 607, 615, 621, 626, 631,
   637, 643, 646, 585, 590, 594, 521, 526, 533, 539, 542, 552, 555, 562, 568, 575,
   419, 424, 430, 434, 438, 443, 450, 456, 460, 467, 477, 487, 497, 509, 241, 246,
...
static final long[] jjtoToken = {
   0xfffffffffffff801L, 0xffffffffffffffffL, 0xfffffc2203ffffffL, 0xffffffffffffffffL,
   0x19L,
};
