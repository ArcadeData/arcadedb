...
private int jjMoveStringLiteralDfa0_0(){
   switch(curChar)
   {
      ...
      case '@':
         return jjStartNfaWithStates_0(0, 183, 1008);
      case '[':
...
private int jjMoveStringLiteralDfa1_0(long active0, long active2, long active3, long active4){
   ...
   switch(curChar)
   {
      ...
      case '?':
         ...
         break;
      case '_':
         return jjMoveStringLiteralDfa2_0(active0, 0x0L, active2, 0x0L, active3, 0x0L, active4, 0x2L);
      case '|':
...
private int jjMoveStringLiteralDfa2_0(long old0, long active0, long old2, long active2, long old3, long active3, long old4, long active4){
   ...
   switch(curChar)
   {
      ...
      case '@':
         return jjMoveStringLiteralDfa3_0(active3, 0x0L, active4, 0x2L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa3_0(long old3, long active3, long old4, long active4){
   ...
   switch(curChar)
   {
      case '=':
         ...
         break;
      case 'r':
         return jjMoveStringLiteralDfa4_0(active3, 0x0L, active4, 0x2L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa10_0(long old4, long active4){
   ...
   {
      case 'a':
         return jjMoveStringLiteralDfa11_0(active4, 0x2L);
      default :
         break;
   }
      ...
      if (curChar < 64)
      {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1061:
                  if (curChar == 45)
                     { jjCheckNAddTwoStates(1062, 1065); }
                  break;
               case 1062:
                  if ((0x3fe000000000000L & l) == 0x0L)
                     break;
               ...
               case 1067:
                  ...
                  if (kind > 170)
                     kind = 170;
                  { jjCheckNAddTwoStates(1067, 1064); }
                  break;
               case 1068:
                  if ((0xff000000000000L & l) == 0x0L)
                     break;
                  if (kind > 170)
                     kind = 170;
                  { jjCheckNAddTwoStates(1068, 1064); }
                  break;
               case 1069:
                  if (curChar == 46)
               ...
               case 1141:
                  ...
                  if (kind > 159)
                     kind = 159;
                  { jjCheckNAddTwoStates(1141, 1057); }
                  break;
               case 1142:
                  if ((0xff000000000000L & l) == 0x0L)
                     break;
                  if (kind > 159)
                     kind = 159;
                  { jjCheckNAddTwoStates(1142, 1057); }
                  break;
               case 1144:
                  if ((0x3ff000000000000L & l) != 0x0L)
                     { jjAddStates(121, 122); }
...
static final int[] jjnextStates = {
   1070, 1071, 1082, 1108, 1110, 1059, 1069, 1058, 1059, 1069, 1104, 1106, 1071, 1082, 33, 35,
   36, 66, 67, 17, 70, 71, 74, 75, 1101, 1102, 1103, 1107, 1084, 1086, 1092, 1093,
   1095, 19, 20, 22, 1056, 1057, 1058, 1059, 1069, 1070, 1071, 1082, 1140, 1142, 1057, 1143,
   1150, 1108, 1110, 1059, 1069, 1104, 1106, 1071, 1082, 13, 14, 17, 19, 20, 24, 22,
   39, 40, 43, 66, 67, 17, 76, 77, 17, 327, 308, 362, 343, 398, 379, 972,
   975, 976, 978, 974, 1061, 1062, 1065, 1066, 1068, 1064, 1073, 1074, 1077, 1078, 1080, 1076,
   1092, 1093, 1095, 1092, 1093, 1097, 1095, 1105, 1071, 1082, 1106, 1071, 1082, 1109, 1059, 1069,
   1110, 1059, 1069, 1113, 1114, 1117, 1126, 1127, 1130, 1144, 1145, 1151, 1152, 1153, 1008, 1012,
   1015, 1019, 1026, 1029, 1032, 1035, 1040, 1047, 1052, 980, 984, 987, 989, 994, 997, 1004,
   912, 913, 917, 922, 934, 940, 944, 947, 953, 958, 966, 903, 907, 864, 867, 873,
   879, 882, 885, 897, 900, 836, 837, 841, 846, 847, 849, 856, 773, 778, 783, 788,
   792, 801, 812, 818, 823, 826, 833, 730, 732, 738, 748, 755, 764, 697, 699, 701,
   703, 704, 708, 715, 719, 727, 680, 684, 688, 691, 649, 652, 655, 659, 666, 669,
   675, 628, 633, 638, 643, 581, 584, 588, 596, 602, 607, 613, 619, 622, 566, 571,
   575, 502, 507, 514, 520, 523, 533, 536, 543, 549, 556, 400, 405, 411, 415, 419,
   424, 431, 437, 441, 448, 458, 468, 478, 490, 222, 227, 230, 238, 242, 243, 248,
   254, 263, 264, 272, 281, 282, 291, 296, 328, 363, 190, 194, 198, 205, 212, 215,
   158, 165, 166, 172, 175, 179, 186, 81, 86, 88, 91, 98, 106, 115, 121, 126,
   130, 135, 139, 144, 149, 152, 1124, 1138, 15, 16, 21, 23, 25, 41, 42, 44,
   68, 69, 72, 73, 78, 79, 1087, 1088, 1090, 1094, 1096, 1098, 1115, 1116, 1118, 1128,
   1129, 1131, 1146, 1147, 1148, 1149, 1154, 1155, 39, 40, 1113, 1114, 1126, 1127,
};
...
static final long[] jjtoToken = {
   0xfffffffffffff801L, 0xffffffffffffffffL, 0xffffff0880ffffffL, 0x3fffffffffffffffL,
   0x3L,
};
...
static final long[] jjtoMore = {
   ...
   0x0L,
    ...
    private final int[] jjrounds = new int[1156];
    private final int[] jjstateSet = new int[2 * 1156];
