...
private int jjMoveStringLiteralDfa0_0(){
   switch(curChar)
   {
      ...
      case '@':
         return jjStartNfaWithStates_0(0, 184, 1032);
      case '[':
      ...
      if (curChar < 64)
      {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1097:
                  if (curChar == 45)
                     { jjCheckNAddTwoStates(1098, 1101); }
                  break;
               case 1098:
                  if ((0x3fe000000000000L & l) == 0x0L)
                     break;
               ...
               case 1103:
                  ...
                  if (kind > 172)
                     kind = 172;
                  { jjCheckNAddTwoStates(1103, 1100); }
                  break;
               case 1104:
                  if ((0xff000000000000L & l) == 0x0L)
                     break;
                  if (kind > 172)
                     kind = 172;
                  { jjCheckNAddTwoStates(1104, 1100); }
                  break;
               case 1105:
                  if (curChar == 46)
               ...
               case 1165:
                  ...
                  if (kind > 160)
                     kind = 160;
                  { jjCheckNAddTwoStates(1165, 1081); }
                  break;
               case 1166:
                  if ((0xff000000000000L & l) == 0x0L)
                     break;
                  if (kind > 160)
                     kind = 160;
                  { jjCheckNAddTwoStates(1166, 1081); }
                  break;
               case 1168:
                  if ((0x3ff000000000000L & l) != 0x0L)
                     { jjAddStates(124, 125); }
...
static final int[] jjnextStates = {
   1094, 1095, 1106, 1132, 1134, 1083, 1093, 1082, 1083, 1093, 1128, 1130, 1095, 1106, 33, 35,
   36, 85, 86, 17, 89, 90, 93, 94, 1125, 1126, 1127, 1131, 1108, 1110, 1116, 1117,
   1119, 19, 20, 22, 1080, 1081, 1082, 1083, 1093, 1094, 1095, 1106, 1164, 1166, 1081, 1167,
   1174, 1132, 1134, 1083, 1093, 1128, 1130, 1095, 1106, 13, 14, 17, 19, 20, 24, 22,
   39, 40, 43, 53, 54, 57, 85, 86, 17, 95, 96, 17, 346, 327, 381, 362,
   417, 398, 996, 999, 1000, 1002, 998, 1085, 1086, 1089, 1090, 1092, 1088, 1097, 1098, 1101,
   1102, 1104, 1100, 1116, 1117, 1119, 1116, 1117, 1121, 1119, 1129, 1095, 1106, 1130, 1095, 1106,
   1133, 1083, 1093, 1134, 1083, 1093, 1137, 1138, 1141, 1150, 1151, 1154, 1168, 1169, 1175, 1176,
   1177, 1032, 1036, 1039, 1043, 1050, 1053, 1056, 1059, 1064, 1071, 1076, 1004, 1008, 1011, 1013,
   1018, 1021, 1028, 931, 932, 936, 941, 953, 958, 964, 968, 971, 977, 982, 990, 922,
   926, 883, 886, 892, 898, 901, 904, 916, 919, 855, 856, 860, 865, 866, 868, 875,
   792, 797, 802, 807, 811, 820, 831, 837, 842, 845, 852, 749, 751, 757, 767, 774,
   783, 716, 718, 720, 722, 723, 727, 734, 738, 746, 699, 703, 707, 710, 668, 671,
   674, 678, 685, 688, 694, 647, 652, 657, 662, 600, 603, 607, 615, 621, 626, 632,
   638, 641, 585, 590, 594, 521, 526, 533, 539, 542, 552, 555, 562, 568, 575, 419,
   ...
   125, 134, 140, 145, 149, 154, 158, 163, 168, 171, 1148, 1162, 15, 16, 21, 23,
   25, 41, 42, 44, 55, 56, 58, 87, 88, 91, 92, 97, 98, 1111, 1112, 1114,
   1118, 1120, 1122, 1139, 1140, 1142, 1152, 1153, 1155, 1170, 1171, 1172, 1173, 1178, 1179, 39,
   40, 53, 54, 1137, 1138, 1150, 1151,
};
...
static final long[] jjtoMore = {
   ...
   0x0L,
    ...
    private final int[] jjrounds = new int[1180];
    private final int[] jjstateSet = new int[2 * 1180];
