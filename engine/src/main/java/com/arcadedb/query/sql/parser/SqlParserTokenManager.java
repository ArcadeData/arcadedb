...
private final int jjStopStringLiteralDfa_0(int pos, long active0, long active1, long active2, long active3, long active4){
   ...
   {
      case 0:
         if ((active0 & 0x80L) != 0L || (active3 & 0x100400L) != 0L)
            return 2;
         if ((active3 & 0x40140L) != 0L)
            return 7;
         if ((active2 & 0x4000000000000L) != 0L || (active3 & 0xc0000000L) != 0L)
            return 16;
...
private int jjMoveStringLiteralDfa0_0(){
   switch(curChar)
   {
      ...
      case 36:
         return jjStartNfaWithStates_0(0, 180, 30);
      case 37:
         jjmatchedKind = 207;
      ...
      case 47:
         jjmatchedKind = 202;
         return jjMoveStringLiteralDfa1_0(0x80L, 0x0L, 0x100000L);
      case 58:
      ...
      case 60:
         jjmatchedKind = 185;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x8100000000000000L, 0x2010004L);
      case 61:
         jjmatchedKind = 182;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x80000000000000L, 0x0L);
      case 62:
         jjmatchedKind = 186;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x0L, 0x3c000001L);
      case 63:
         jjmatchedKind = 189;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x0L, 0x1000L);
      case 64:
         return jjStartNfaWithStates_0(0, 179, 1033);
      case 91:
      ...
      case 124:
         jjmatchedKind = 205;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x0L, 0x400008L);
      case 125:
...
private int jjMoveStringLiteralDfa1_0(long active0, long active2, long active3){
   ...
   switch(curChar)
   {
      ...
      case 45:
         if ((active3 & 0x40L) != 0L)
            return jjStartNfaWithStates_0(1, 198, 4);
         break;
      case 46:
      ...
      case 61:
         ...
         return jjMoveStringLiteralDfa2_0(active0, 0L, active2, 0x100000000000000L, active3, 0L);
      case 62:
         if ((active3 & 0x4L) != 0L)
         ...
         return jjMoveStringLiteralDfa2_0(active0, 0L, active2, 0L, active3, 0x2c000000L);
      case 63:
...
private int jjMoveNfa_0(int startState, int curPos)
{
   ...
   for (;;)
   {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1156:
                  ...
                  if (kind > 155)
                     kind = 155;
                  { jjCheckNAddTwoStates(1156, 1076); }
                  break;
               case 1157:
                  if ((0xff000000000000L & l) == 0L)
                     break;
                  if (kind > 155)
                     kind = 155;
                  { jjCheckNAddTwoStates(1157, 1076); }
                  break;
               case 1159:
                  if ((0x3ff000000000000L & l) != 0L)
                     { jjAddStates(120, 121); }
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 266:
                  ...
                  break;
               case 267:
                  if ((0x200000002000L & l) != 0L && kind > 143)
                     kind = 143;
                  break;
               case 268:
                  if ((0x10000000100000L & l) != 0L)
               ...
               case 358:
                  ...
                  break;
               case 359:
                  if ((0x100000001000000L & l) != 0L && kind > 98)
                     kind = 98;
                  break;
               case 360:
                  if ((0x200000002000L & l) != 0L)
               ...
               case 804:
                  ...
                  break;
               case 805:
                  if ((0x100000001000000L & l) != 0L && kind > 128)
                     kind = 128;
                  break;
               case 806:
                  if ((0x800000008000L & l) != 0L)
               ...
               case 810:
                  ...
                  break;
               case 811:
                  if ((0x10000000100L & l) != 0L && kind > 137)
                     kind = 137;
                  break;
               case 812:
                  if ((0x200000002L & l) != 0L)
      ...
      ++curPos;
      if ((i = jjnewStateCnt) == (startsAt = 1171 - (jjnewStateCnt = startsAt)))
         return curPos;
      try { curChar = input_stream.readChar(); }
...
static final int[] jjnextStates = {
   1089, 1090, 1101, 1123, 1125, 1078, 1088, 1077, 1078, 1088, 1119, 1121, 1090, 1101, 32, 34,
   35, 84, 85, 20, 88, 89, 92, 93, 1116, 1117, 1118, 1122, 1103, 1105, 1111, 1112,
   1114, 22, 23, 25, 1075, 1076, 1077, 1078, 1088, 1089, 1090, 1101, 1155, 1157, 1076, 1158,
   1165, 1123, 1125, 1078, 1088, 1119, 1121, 1090, 1101, 16, 17, 20, 38, 39, 42, 52,
   53, 56, 84, 85, 20, 94, 95, 20, 217, 220, 221, 223, 219, 439, 420, 474,
   455, 510, 491, 939, 940, 1005, 1006, 1080, 1081, 1084, 1085, 1087, 1083, 1092, 1093, 1096,
   1097, 1099, 1095, 1111, 1112, 1114, 1120, 1090, 1101, 1121, 1090, 1101, 1124, 1078, 1088, 1125,
   1078, 1088, 1128, 1129, 1132, 1141, 1142, 1145, 1159, 1160, 1166, 1167, 1168, 1033, 1037, 1040,
   1044, 1049, 1056, 1061, 1064, 1066, 1069, 1072, 1013, 1017, 1019, 1022, 1029, 1001, 1008, 974,
   977, 980, 983, 995, 998, 934, 935, 942, 943, 948, 949, 951, 959, 966, 880, 885,
   890, 895, 899, 910, 916, 921, 924, 931, 837, 839, 845, 855, 862, 871, 817, 821,
   825, 828, 831, 779, 782, 785, 789, 794, 801, 804, 806, 812, 745, 750, 755, 760,
   765, 693, 696, 700, 708, 714, 719, 724, 730, 736, 739, 678, 683, 687, 615, 620,
   627, 632, 638, 641, 651, 654, 661, 668, 512, 517, 522, 528, 532, 537, 544, 550,
   554, 561, 571, 581, 591, 603, 340, 345, 348, 356, 360, 365, 371, 372, 380, 389,
   390, 394, 403, 408, 440, 475, 301, 305, 309, 316, 323, 330, 333, 269, 276, 277,
   283, 286, 290, 297, 225, 230, 232, 235, 242, 250, 255, 259, 263, 129, 133, 134,
   138, 143, 155, 160, 166, 188, 192, 198, 203, 211, 99, 103, 105, 107, 109, 110,
   114, 118, 126, 1139, 1153, 5, 6, 18, 19, 40, 41, 43, 54, 55, 57, 86,
   87, 90, 91, 96, 97, 1106, 1107, 1109, 1130, 1131, 1133, 1143, 1144, 1146, 1161, 1162,
   1163, 1164, 1169, 1170, 38, 39, 52, 53, 1128, 1129, 1141, 1142,
};
...
static final long[] jjtoToken = {
   0xfffffffffffff001L, 0xffffffffffffffffL, 0xfffffff0887fffffL, 0x9fffffffffffffffL,
   0x0L,
};
...
static final long[] jjtoMore = {
   ...
   0x0L,
    ...
    private final int[] jjrounds = new int[1171];
    private final int[] jjstateSet = new int[2 * 1171];
