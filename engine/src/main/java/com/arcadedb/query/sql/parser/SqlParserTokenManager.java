...
private int jjMoveStringLiteralDfa0_0(){
   switch(curChar)
   {
      ...
      case '@':
         return jjStartNfaWithStates_0(0, 186, 1046);
      case '[':
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1023:
                  ...
                  if (kind > 252)
                     kind = 252;
                  { jjCheckNAddTwoStates(1023, 1020); }
                  break;
               case 1024:
                  if ((0xff000000000000L & l) == 0x0L)
                     break;
                  if (kind > 252)
                     kind = 252;
                  { jjCheckNAddTwoStates(1024, 1020); }
                  break;
               case 1087:
                  if ((0x3fe000000000000L & l) == 0x0L)
                     break;
               ...
               case 1173:
                  ...
                  if (kind > 162)
                     kind = 162;
                  { jjCheckNAddTwoStates(1173, 1089); }
                  break;
               case 1174:
                  if ((0xff000000000000L & l) == 0x0L)
                     break;
                  if (kind > 162)
                     kind = 162;
                  { jjCheckNAddTwoStates(1174, 1089); }
                  break;
               case 1176:
                  if ((0x3ff000000000000L & l) != 0x0L)
                     { jjAddStates(124, 125); }
...
static final int[] jjnextStates = {
   1102, 1103, 1114, 1140, 1142, 1091, 1101, 1090, 1091, 1101, 1136, 1138, 1103, 1114, 85, 86,
   17, 89, 90, 93, 94, 1133, 1134, 1135, 1139, 1116, 1118, 1124, 1125, 1127, 19, 20,
   22, 1088, 1089, 1090, 1091, 1101, 1102, 1103, 1114, 1172, 1174, 1089, 1175, 1182, 1140, 1142,
   1091, 1101, 1136, 1138, 1103, 1114, 33, 35, 36, 13, 14, 17, 19, 20, 24, 22,
   39, 40, 43, 53, 54, 57, 85, 86, 17, 95, 96, 17, 376, 357, 411, 392,
   447, 428, 1018, 1021, 1022, 1024, 1020, 1093, 1094, 1097, 1098, 1100, 1096, 1105, 1106, 1109,
   1110, 1112, 1108, 1124, 1125, 1127, 1124, 1125, 1129, 1127, 1137, 1103, 1114, 1138, 1103, 1114,
   1141, 1091, 1101, 1142, 1091, 1101, 1145, 1146, 1149, 1158, 1159, 1162, 1176, 1177, 1183, 1184,
   1185, 1046, 1050, 1053, 1057, 1062, 1069, 1074, 1077, 1079, 1082, 1085, 1026, 1030, 1032, 1035,
   1042, 957, 958, 963, 975, 980, 986, 990, 993, 999, 1004, 1012, 948, 952, 909, 912,
   918, 924, 927, 930, 942, 945, 873, 874, 878, 883, 884, 886, 894, 901, 810, 815,
   820, 825, 829, 838, 849, 855, 860, 863, 870, 767, 769, 775, 785, 792, 801, 750,
   754, 758, 761, 712, 715, 718, 722, 727, 734, 737, 739, 745, 691, 696, 701, 706,
   639, 642, 646, 654, 660, 665, 670, 676, 682, 685, 624, 629, 633, 560, 565, 572,
   578, 581, 591, 594, 601, 607, 614, 449, 454, 459, 465, 469, 473, 477, 482, 489,
   495, 499, 506, 516, 526, 536, 548, 271, 276, 279, 287, 291, 292, 297, 303, 312,
   313, 321, 330, 331, 340, 345, 377, 412, 239, 243, 247, 254, 261, 264, 207, 214,
   215, 221, 224, 228, 235, 130, 135, 137, 140, 147, 155, 164, 170, 175, 179, 184,
   188, 193, 198, 201, 100, 104, 106, 108, 110, 111, 115, 119, 127, 1156, 1170, 15,
   16, 21, 23, 25, 41, 42, 44, 55, 56, 58, 87, 88, 91, 92, 97, 98,
   1119, 1120, 1122, 1126, 1128, 1130, 1147, 1148, 1150, 1160, 1161, 1163, 1178, 1179, 1180, 1181,
   1186, 1187, 39, 40, 53, 54, 1145, 1146, 1158, 1159,
};
...
static final long[] jjtoMore = {
   ...
   0x0L,
    ...
    private final int[] jjstateSet = new int[2 * 1188];
