...
public class TokenMgrException extends RuntimeException {
   ...
   * Full Constructor.
   */
  public TokenMgrException(final boolean EOFSeen, final int lexState, final int errorLine, final int errorColumn, final String errorAfter, final int curChar,
      final int reason) {
    this(LexicalErr(EOFSeen, lexState, errorLine, errorColumn, errorAfter, curChar), reason);
  }
}
/* ParserGeneratorCC - OriginalChecksum=7c0abf2210691a16f05042670750a96d (do not edit this line) */
