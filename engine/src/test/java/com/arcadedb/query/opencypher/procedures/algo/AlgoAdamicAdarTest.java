...
/**
 * Tests for the algo.adamicAdar Cypher procedure.
 */
class AlgoAdamicAdarTest {
  private Database database;

  @BeforeEach
  void setup() {
    final DatabaseFactory factory = new DatabaseFactory("./target/databases/test-algo-adamic-adar");
    if (factory.exists())
      factory.open().drop();
    ...
    // With BOTH direction:
    //   B has degree 2 (connected to A and E)
    //   C has degree 2 (connected to A and E)
    //   Adamic-Adar(A,E) = 1/log(2) + 1/log(2) > 0
