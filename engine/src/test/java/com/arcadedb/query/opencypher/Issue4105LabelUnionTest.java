...
/**
 * Regression test for GitHub issue #4105.
 * <p>
 * The Cypher node label-union syntax {@code (n:A|B)} must match nodes that
 * have either label, matching Neo4j.
 *
 * @author Luca Garulli (l.garulli@arcadedata.com)
 */
class Issue4105LabelUnionTest {
