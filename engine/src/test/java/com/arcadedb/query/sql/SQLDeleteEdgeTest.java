...
public class SQLDeleteEdgeTest extends TestHelper {
  ...
  public void testDeleteFromTo() {
    database.transaction(() -> {
      ...
      List<Document> result = CollectionUtils.resultsetToListOfDocuments(database.query("sql", "select from testFromToV"));
      ...
      long deleted = (long) CollectionUtils.getFirstResultValue(database.command("sql", "DELETE VERTEX from testFromToV"), "count");
    });
  }
  ...
  public void testDeleteFrom() {
    database.transaction(() -> {
      ...
      List<Document> result = CollectionUtils.resultsetToListOfDocuments(database.query("sql", "select from testFromV"));
      ...
      long deleted = (long) CollectionUtils.getFirstResultValue(database.command("sql", "DELETE VERTEX from testFromV"), "count");
    });
  }
  ...
  public void testDeleteTo() {
    database.transaction(() -> {
      ...
      List<Document> result = CollectionUtils.resultsetToListOfDocuments(database.query("sql", "select from testToV"));
      ...
      long deleted = (long) CollectionUtils.getFirstResultValue(database.command("sql", "DELETE VERTEX from testToV"), "count");
    });
  }
  ...
  public void testDropTypeVandEwithUnsafe() {
    database.transaction(() -> {
      ...
      Identifiable v1 = CollectionUtils.getFirstResultAsDocument(database.command("sql", "create vertex SuperV set name = 'Luca'"));
      Identifiable v2 = CollectionUtils.getFirstResultAsDocument(database.command("sql", "create vertex SuperV set name = 'Mark'"));
  ...
  public void testDropTypeVandEwithDeleteElements() {
    database.transaction(() -> {
      ...
      long deleted = (long) CollectionUtils.getFirstResultValue(database.command("sql", "DELETE FROM SuperV"), "count");
  ...
  public void testFromInString() {
    database.transaction(() -> {
      ...
      Identifiable v1 = CollectionUtils.getFirstResultAsDocument(database.command("sql", "create vertex FromInStringV set name = ' from '"));
      Identifiable v2 = CollectionUtils.getFirstResultAsDocument(database.command("sql", "create vertex FromInStringV set name = ' FROM '"));
      Identifiable v3 = CollectionUtils.getFirstResultAsDocument(database.command("sql", "create vertex FromInStringV set name = ' TO '"));
  ...
  public void testDeleteVertexWithReturn() {
    database.transaction(() -> {
      ...
      Identifiable v1 = CollectionUtils.getFirstResultAsDocument(database.command("sql", "create vertex V set returning = true"));

      List<Document> v2s = CollectionUtils.resultsetToListOfDocuments(database.command("sql", "delete vertex from V return before where returning = true"));
